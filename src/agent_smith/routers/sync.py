...
async def sync_single_item(item_type: str, item_id: int, dry_run: bool = Query(False)):
    message = await AgentSmithSyncService().sync_item(item_type=item_type, item_id=item_id, dry_run=dry_run)
